...
public:
	...
	explicit NoSuchFieldException(const std::string&type_name);
...
NoSuchFieldException::NoSuchFieldException(const std::string&type_name)
{
	std::ostringstream oss;
	oss<<"Object of type <"<<type_name<<"> dose not have field named .";
	this->message=oss.str();
}
